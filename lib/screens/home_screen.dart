    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          _HeroBanner(
            onJobSearch: () => Navigator.push(context, MaterialPageRoute(builder: (_) => JobsScreen(currentUserId: 'user'))),
          ...
          _QuickActions(
            onLocalJob: () => Navigator.push(context, MaterialPageRoute(builder: (_) => JobsScreen(currentUserId: 'user'))),
            onBaharJob: () => Navigator.push(context, MaterialPageRoute(builder: (_) => JobsScreen(currentUserId: 'user'))),
            onWorkers:  () => Navigator.push(context, MaterialPageRoute(builder: (_) => const WorkerMarketplaceScreen())),
            onEmployer: () => Navigator.push(context, MaterialPageRoute(builder: (_) => EmployerJobManagementScreen(employerId: 'emp1', employerName: 'Employer'))),
          ),
          ...
          _SectionHeader(title: '🏠 लोकल नौकरियाँ', subtitle: 'अपने इलाके में काम',
            onSeeAll: () => Navigator.push(context, MaterialPageRoute(builder: (_) => JobsScreen(currentUserId: 'user')))),
          ...
          const _CityGuide(),
          _EmployerCta(onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => EmployerJobManagementScreen(employerId: 'emp1', employerName: 'Employer')))),
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        _MenuItem(icon: '💼', label: 'जॉब्स देखें',
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => JobsScreen(currentUserId: 'user')))),
        ...
        _MenuItem(icon: '📢', label: 'Job Post करें (Employer)',
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => EmployerJobManagementScreen(employerId: 'emp1', employerName: 'Employer')))),
